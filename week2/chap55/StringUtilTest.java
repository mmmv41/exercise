...
public class StringUtilTest {
    public static void main(String[] args) {
        ...
        int countChar = StringUtils.CharChecker.countChar(str2, target);
        System.out.println("'o'는 몇개가 있을까?: " + countChar );

        // 4. 주어진 문자열에 특정 문자가 있는지 확인 
        boolean containsChar = StringUtils.CharChecker.containsChar(str, target);
        System.out.println("'o'가 있는지 확인: " + containsChar);
    }
}
